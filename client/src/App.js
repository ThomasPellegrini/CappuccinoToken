...
class App extends Component {
   state = { loaded: false, kycAddress: "0x123", tokenSaleAddress: "", myTokenAddress: "", userTokens: 0 };
    componentDidMount = async () => {
      try {
          ...
          this.setState({ loaded:true, tokenSaleAddress: this.myTokenSale._address, myTokenAddress: this.myToken._address }, this.updateUserTokens);
      } catch (error) {
  ...
  render() {
    ...
    return (
        ...
        <div className="App">
          ...
          <p>Token address: {this.state.myTokenAddress}</p>
